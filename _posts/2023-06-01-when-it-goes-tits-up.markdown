...
1. thanks  
2. yeah you\'ve got your name out there as knowing lots, albeit on an issue that has occurred, as opposed to *not yet occurred when we were working on it* – which is where we came from.
