...
This makes it ideal for: CTF writeups, incident notes, K8s quirks, cloud misconfig tricks, THM room plans, and content ideas.

---

## Step 1: Set Up Your First Vault (Without Over‑Engineering It)
...
## Step 2: Links, Backlinks, and the Graph

Obsidian is Markdown‑first:

- `# Heading`, `-` for lists, fenced code blocks for snippets.
...
- Incidents.
- Talks/courses.
- On‑call rotations and incident reviews.

---

## Step 5: A Simple Vault Structure That Actually Works
...
Maps are hub notes — high‑level index pages with links to other notes, like a manual written by future you for future you.
...
- Architecting something in K8s.
- Reading a spec or blog post.
